...
const translations = {
  ...
  ar: {
    ...
    hero_bio:
      "<strong>مطور برمجيات وواجهات أمامية</strong> بخلفية قوية في الصف الحادي عشر المسار العلمي (معدل 95.4%). قمت بتطوير <strong>أكثر من 15 مشروعاً منشورة على GitHub</strong>  تشمل معمارية الويب المستجيبة، وبوتات الأتمتة الآمنة، وسكربتات أمن الشبكات. خبير في تحسين الأنظمة التقنية وتنسيق الفرق لتقديم برمجيات جاهزة للإنتاج.",
